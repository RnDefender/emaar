 ...
 */
    ...
    ***************************************************************************** */                var __assign = function() {
                ...
                var Thumbnail = function() {
                    ...
                    Thumbnail.prototype.setThumbMarkup = function() {
                        ...
                        if (this.settings.appendThumbnailsTo === ".lg-components") this.core.$lgComponents.append(html); else this.core.outer.append(html);
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        class Popup {
            ...
            eventsPopup() {
                ...
                document.addEventListener("keydown", function(e) {
                    const hasLgOnClass = document.documentElement.classList.contains("lg-on");
                    if (!hasLgOnClass) {
        ...
        tippy_esm(".location__tip_1", {
            content: '<a href="#" class="tippy-content__image-ibg" aria-label="Dubai Creek Harbour"><img src="img/location/dubai-creek-harbour.jpg" alt="Dubai Creek Harbour" width="200" height="120"></a><h3 class="tippy-content__title"><a href="#" class="tippy-content__title-link" aria-label="Dubai Creek Harbour">DUBAI CREEK HARBOUR</a></h3>',
            allowHTML: true,
            offset: [ 0, -10 ],
            maxWidth: "202px",
            interactive: true,
        ...
        tippy_esm(".location__tip_2", {
            content: '<a href="#" class="tippy-content__image-ibg" aria-label="Dubai Hills Estate"><img src="img/location/dubai-creek-harbour.jpg" alt="Dubai Hills Estate" width="200" height="120"></a><h3 class="tippy-content__title"><a href="#" class="tippy-content__title-link" aria-label="Dubai Hills Estate">Dubai Hills Estate</a></h3>',
            allowHTML: true,
            offset: [ 0, -10 ],
            maxWidth: "202px",
            interactive: true,
        ...
        tippy_esm(".location__tip_3", {
            content: '<a href="#" class="tippy-content__image-ibg" aria-label="Emaar South"><img src="img/location/dubai-creek-harbour.jpg" alt="Emaar South" width="200" height="120"></a><h3 class="tippy-content__title"><a href="#" class="tippy-content__title-link" aria-label="Emaar South">Emaar South</a></h3>',
            allowHTML: true,
            offset: [ 0, -10 ],
            maxWidth: "202px",
            interactive: true,
        ...
        function initSliders() {
            if (document.querySelector(".body-item-projects__slider_1")) new core(".body-item-projects__slider_1", {
                ...
                speed: 800,
                pagination: {
                    el: ".body-item-projects__pagination_1",
                    type: "fraction"
                },
                lazy: true,
                navigation: {
                    prevEl: ".body-item-projects__button-prev_1",
                    nextEl: ".body-item-projects__button-next_1"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".body-item-projects__slider_2")) new core(".body-item-projects__slider_2", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".body-item-projects__pagination_2",
                    type: "fraction"
                },
                lazy: true,
                navigation: {
                    prevEl: ".body-item-projects__button-prev_2",
                    nextEl: ".body-item-projects__button-next_2"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".body-item-projects__slider_3")) new core(".body-item-projects__slider_3", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".body-item-projects__pagination_3",
                    type: "fraction"
                },
                lazy: true,
                navigation: {
                    prevEl: ".body-item-projects__button-prev_3",
                    nextEl: ".body-item-projects__button-next_3"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".blueprints__slider")) new core(".blueprints__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".blueprints__pagination",
                    type: "fraction"
                },
                lazy: true,
                navigation: {
                    prevEl: ".blueprints__button-prev",
                    nextEl: ".blueprints__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
...
***************************************************************************** */
        ...
        da.init();
        gsap.to(".header__bg-ibg", {
            scrollTrigger: {
                trigger: ".header__bg-ibg",
                start: "top top",
                end: "bottom top",
                scrub: true
            },
        ...
        gsap.from(".homes__title", {
            y: "100%",
            duration: .4,
            opacity: 0,
            ease: "power1.in",
            scrollTrigger: {
                trigger: ".homes__title",
                start: "top 100%",
                end: "center 80%",
                scrub: true,
        ...
        gsap.from(".homes__image-ibg", {
            filter: "blur(20px)",
            duration: 1.6,
            scrollTrigger: {
                trigger: ".homes__image-ibg",
                start: "top 99%",
                end: "bottom 100%",
                toggleActions: "play none none reverse"
            }
